...
echo "Account: Heineken `date`"
$JAVA -jar $JAR -from "15 days ago" -to "yesterday" -overwrite-data false -replace-data true -concurrent false -configFileName "-config.properties" -runners "\
